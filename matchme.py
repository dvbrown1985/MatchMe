...
with st.form("my_form"):
    ...
    if submitted: # Check if the form was submitted
        ...
        analyze_experience_against_job_description = f"""
            ...
            ** Example Output **: Do not add additional narrative or context other than the structure listed below. Output format must be in markdown. Do not output any HTML code or tags such as <br>. You must include a line break before and after each category in the example output. Generate verbose responses. 
    
                Overall match assessment: Make this line Bold. Use Line Breaks to make the content readable and intuitive. Use bullet points to segment the output. Make sure the bullet points are indented. 
                ...
                Relevant Experience: Make this line Bold. Use Line Breaks to make the content readable and intuitive. Use bullet points to segment the output.Make sure the bullet points are indented.Make sure the bullet points are indented.
                    - List the relevant job seekers experience and explain how and why it matches the requirements of the job postings.
                    <insert line break> do not output <br>
                Experience Gaps: Make this line Bold. Use Line Breaks to make the content readable and intuitive. Use bullet points to segment the output. Make sure the bullet points are indented. Make sure the bullet points are indented.
                    ...
                    <insert line break> do not output <br>
                Skills Assessment: Make this line Bold. Use Line Breaks to make the content readable and intuitive. Use bullet points to segment the output. Make sure the bullet points are indented.
                    - List the relevant job seeker skills that are most applicable to this role and how they can be applied to the role.
                    <insert line break> do not output <br>
                Skill Gap Analysis: Make this line Bold. Use Line Breaks to make the content readable and intuitive. Use bullet points to segment the output. Make sure the bullet points are indented.
                    ...
                    <insert line break> do not output <br>
                Creating a Tailored Resume: Make this line Bold. Use Line Breaks to make the content readable and intuitive. Use bullet points to segment the output. Make sure the bullet points are indented.
                    ...
                    <insert line break> do not output <br>
                Creating a Cover Letter: Make this line Bold. Use Line Breaks to make the content readable and intuitive. Use bullet points to segment the output. Make sure the bullet points are indented.
                    ...
                    <insert line break> do not output <br>
                Interview Questions for the Employer: Make this line Bold. Use Line Breaks to make the content readable and intuitive. Use bullet points to segment the output. Make sure the bullet points are indented.
                    - Provide 5 to 7 recommended interview questions for the job seeker to ask of the hiring team.
                    <insert line break> do not output <br>
                Interview Questions to Prepare the Job Seeker: Make this line Bold. Make this line Bold. Use Line Breaks to make the content readable and intuitive. Use bullet points to segment the output. Make sure the bullet points are indented.
